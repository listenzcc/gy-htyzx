...
from page_components.experiments_page import experiments_gallery, experiments_plan_gallery, stimulation_plan_gallery
...
async def experiments_page():
    ...
    ui.separator()
    stimulation_plan_gallery(user.id, user.uuid, user_service)
